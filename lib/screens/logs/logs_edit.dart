...
LogEditPage({required this.logsModel});
@override
_LogPageState createState() => _LogPageState();
}

class _LogPageState extends State<LogEditPage> {
...
void initState() {
super.initState();
_selectedType = widget.logsModel.type;
_selectedVenue = widget.logsModel.venue;
_selectedPerformance =
_performances[widget.logsModel.performence ?? 0];
_dateController.text = widget.logsModel.date ?? '';
_timeController.text = widget.logsModel.time?.toString() ?? '';
_venueController.text = widget.logsModel.venue ?? '';
_notesController.text = widget.logsModel.notes ?? '';
}
            ...
            child: Row(
              ...
              children: [
                IconButton(
                    ...
                    widget.logsModel.date = _dateController.text;
                    widget.logsModel.type = _selectedType;
                    widget.logsModel.venue = _venueController.text;
                    widget.logsModel.notes = _notesController.text;
                    widget.logsModel.performence = indexx!;
                    widget.logsModel.time = int.tryParse(_timeController.text) ?? 0;
                    
                    final box = Boxes.getData3();
                    int index = box.values.toList().indexOf(widget.logsModel);
                    box.putAt(index, widget.logsModel);
